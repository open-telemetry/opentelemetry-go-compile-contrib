module go.opentelemetry.io/otelc-contrib/instrumentation/github.com/openai/openai-go/v3
...
require (
	...
	go.opentelemetry.io/otelc-contrib/instrumentation/github.com/openai/openai-go/internal/streaming v0.0.0
...
require (
	...
	go.opentelemetry.io/otelc-contrib/instrumentation/github.com/openai/openai-go/internal/streaming => ../internal/streaming
